...
final class UpdateFavoriteGamesPresenterTests: XCTestCase {
    ...
    private var presenter: GetListPresenter<GamesModel, GamesModel, FakeUpdateFavoriteGamesInteractor>?
    ...
    func testGetList() {
        presenter?.getList(request: GameTransformer().transformResponseToDomain(response: GamesResponse.fakeGame))
